      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 flex-1">
            ...
            <Link href="/blogg" className="text-sm font-medium transition-colors hover:opacity-70" style={{ color: websiteData.primary_color }}>
              Blogg
            </Link>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-6 flex-1 justify-end">
            <Link href="/om-oss" className="text-sm font-medium transition-colors hover:opacity-70" style={{ color: websiteData.primary_color }}>
              Om oss
            </Link>
            <Link
              href="/kontakt"
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${isMenuOpen ? 'max-h-72 opacity-100' : 'max-h-0 opacity-0'}`}>
          <nav className="flex flex-col gap-2 pt-4 mt-3 border-t" style={{ borderColor: websiteData.secondary_color }}>
            ...
            <Link href="/blogg" className="rounded-lg font-medium transition-colors hover:bg-black/5" style={{ color: websiteData.primary_color, padding: '0.75rem' }} onClick={() => setIsMenuOpen(false)}>
              Blogg
            </Link>
            <Link href="/om-oss" className="rounded-lg font-medium transition-colors hover:bg-black/5" style={{ color: websiteData.primary_color, padding: '0.75rem' }} onClick={() => setIsMenuOpen(false)}>
              Om oss
            </Link>
            <Link
              href="/kontakt"
