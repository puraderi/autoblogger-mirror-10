        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex items-center gap-3">
            {websiteData.icon_identifier && iconToUrl(websiteData.icon_identifier) ? (
              <img src={iconToUrl(websiteData.icon_identifier)!} alt="" className="w-5 h-5 opacity-60" />
            ) : websiteData.logo_url ? (
              <Image src={websiteData.logo_url} alt={websiteData.website_name} width={20} height={20} className="object-contain opacity-60" />
            ) : null}
