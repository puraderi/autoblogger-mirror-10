    ...
    <footer className="mt-auto border-t py-12" style={{ borderColor: websiteData.secondary_color }}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: websiteData.primary_color }}>Snabblänkar</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4" style={{ color: websiteData.primary_color }}>Följ oss</h4>
