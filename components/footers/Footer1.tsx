    ...
    <footer className="mt-auto border-t-2 pt-12 pb-8" style={{ borderColor: websiteData.secondary_color }}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand column */}
          <div>
            <h3 className="font-bold text-xl mb-4" style={{ color: websiteData.primary_color }}>
              {websiteData.website_name}
            </h3>
            <p className="text-sm text-gray-600 leading-relaxed mb-4">{websiteData.topic}</p>
            {/* Social icons row */}
            <div className="flex items-center gap-3">
              {websiteData.social_twitter && (
                <a href={websiteData.social_twitter} className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ backgroundColor: `${websiteData.secondary_color}40` }}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" style={{ color: websiteData.primary_color }}><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
              )}
              {websiteData.social_facebook && (
                <a href={websiteData.social_facebook} className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ backgroundColor: `${websiteData.secondary_color}40` }}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" style={{ color: websiteData.primary_color }}><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
              )}
              {websiteData.social_instagram && (
                <a href={websiteData.social_instagram} className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ backgroundColor: `${websiteData.secondary_color}40` }}>
              ...
              {websiteData.social_linkedin && (
                <a href={websiteData.social_linkedin} className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110" style={{ backgroundColor: `${websiteData.secondary_color}40` }}>
