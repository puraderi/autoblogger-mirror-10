    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <a
          ...
          className={`p-2.5 ${websiteData.border_radius} transition-all hover:opacity-80 hover:scale-105`}
          style={{ backgroundColor: websiteData.primary_color, color: getContrastTextColor(websiteData.primary_color) }}
          title={lang.labels.shareOnX}
        >
        ...
        <a
          ...
          className={`p-2.5 ${websiteData.border_radius} transition-all hover:opacity-80 hover:scale-105`}
          style={{ backgroundColor: websiteData.primary_color, color: getContrastTextColor(websiteData.primary_color) }}
          title={lang.labels.shareOnFacebook}
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          className={`p-2.5 ${websiteData.border_radius} transition-all hover:opacity-80 hover:scale-105`}
          style={{ backgroundColor: websiteData.primary_color, color: getContrastTextColor(websiteData.primary_color) }}
          title={lang.labels.shareOnLinkedIn}
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
